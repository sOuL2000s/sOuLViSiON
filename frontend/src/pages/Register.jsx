    ...
    return (
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', flexGrow: 1, padding: '1rem' }}>
            <div style={{ width: '100%', maxWidth: '400px', padding: '3rem 2rem', border: '1px solid var(--border)', borderRadius: '24px', background: 'rgba(10, 10, 10, 0.8)', boxShadow: 'var(--shadow)' }}>
                <h1 style={{ fontSize: '2.5rem', marginBottom: '2rem', fontWeight: '800' }}>Sign Up</h1>
                <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1.2rem' }}>
                    ...
                    <button type="submit" className="counter" style={{ cursor: 'pointer', border: 'none', padding: '1rem', background: 'var(--accent)', color: '#000', fontWeight: 'bold', fontSize: '1rem' }}>Register</button>
                </form>

                <div style={{ margin: '1.5rem 0', display: 'flex', alignItems: 'center', gap: '1rem' }}>
                    <div style={{ flex: 1, height: '1px', background: 'var(--border)' }}></div>
                    <span style={{ fontSize: '0.8rem', color: 'var(--text)', opacity: 0.5 }}>OR JOIN WITH</span>
                    <div style={{ flex: 1, height: '1px', background: 'var(--border)' }}></div>
                </div>
                ...
                <p style={{ marginTop: '2rem', color: 'var(--text)' }}>
                    Part of the vision? <Link to="/login" style={{ color: 'var(--accent)', textDecoration: 'none', fontWeight: 'bold' }}>Sign In</Link>
                </p>
            </div>
        </div>
    );
